...
export default function CreateHousing() {
  ...
  const updateForm = (field: FormTextKey, text: string) => {
    setForm((prevForm) => ({
      ...prevForm,
      [field]: text,
    }));
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const { data } = isEditing
        ? await apiClient.put(`/housing/${editId}`, payload)
        : await apiClient.post("/housing", payload);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FormField
          label="Room Title"
          place="e.g., Single Room Near Campus"
          val={form.title}
          field="title"
          updateForm={updateForm}
          className="mb-4"
        ...
        <FormField
          label="Description"
          place="Tell more about the room..."
        ...
        <FormField
          ...
          place="Street address, area, near landmarks"
          val={form.address}
          field="address"
          icon={MapPin}
          updateForm={updateForm}
        ...
        <ToggleField
          label="Room Type"
          options={["Single", "Shared", "Apartment"]}
        ...
        <CheckboxField
          ...
          value={form.parking}
          onChange={() => toggleFeature("parking")}
          className="mb-4"
        />
