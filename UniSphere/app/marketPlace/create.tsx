          ...
          >
            <VStack space="xl" className="mt-4">
              ...
              <TextInput
                ...
                className="bg-gray-50 p-5 rounded-2xl text-lg font-bold border border-gray-100"
              />
              ...
              <TextInput
                ...
                className="bg-gray-50 p-5 rounded-3xl text-base h-40 border border-gray-100"
              />
            </VStack>
          </ScrollView>
